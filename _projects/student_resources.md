...
- [Astronomy as a Field: A Guide for Aspiring Astrophysicistis](https://arxiv.org/abs/2312.04041){:target="_blank"}
...
- [INSPIRE](https://inspirehep.net){:target="_blank"} -- ADS, but for high energy physics, so sometimes better for complete for cosmology and astroparticle literature
...
- Brooke Owens Fellowship -- for women in aerospace, but held by many now-astronomers
...
#### Humor
Much of (astro)physics shares a common cultural lexicon, some of which comes from popular media and some of which comes from relatively niche webcomics. If you have not already, you will certainly encounter references to [xkcd](https://xkcd.com){:target="_blank"} (so essential to science that it has it's own `matplotlib` [module](https://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.xkcd.html){:target="_blank"}) and you will likely also see -- and possibly relate to -- [PhD Comics](https://phdcomics.com){:target="_blank"}.