...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <iframe src="{{ '/assets/plotly/interactive_dlps.html' | relative_url }}" frameborder='0' scrolling='no' height="630px" width="800pt"></iframe>
    </div>
</div>
...
[Polzin et al. (2023a)](https://ui.adsabs.harvard.edu/abs/2022arXiv221101232P/abstract)
...
You can also play with an interactive version of the full DLPS above or some of the other phase space plots below (<em>note: if you are using Firefox as a browser, the interactive plots may not appear in full; switching to Safari or Chrome -- or Chrome products like Brave -- should fix it</em>).
