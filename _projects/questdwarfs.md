...
QUEST Dwarfs DR1 is out now on [questdwarfs.github.io](https://questdwarfs.github.io){:target="_blank"}!

The results of various QUEST Dwarfs papers are summarized briefly here. 
<!-- Where more detailed summaries are available, they are also linked here. -->
- [Sample definition and first results (Polzin et al. 2026)](https://arxiv.org/abs/2608.15782){:target="_blank"}: 
	- CGM constraints from 14 dwarf galaxies (20% of full sample) via 16 sightlines; 9 sightlines within 0.3 R<sub>vir</sub>
	...
	- Preliminary analysis of "low-mass" (log M<sub><span style="font-size:75%">&#9733;</span></sub>/M<sub>&#9737;</sub> < 8) and "high-mass" (log M<sub><span style="font-size:75%">&#9733;</span></sub>/M<sub>&#9737;</sub> &ge; 8) dwarf bins suggests that the CGM holds ~3% and ~16% respectively of the metals produced by the galaxies